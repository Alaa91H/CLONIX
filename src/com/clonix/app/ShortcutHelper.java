...
public final class ShortcutHelper {
    ...
    private static ShortcutInfo build(Context c, String title, Drawable baseIcon,
                                      CloneStore.Clone cl) {
        Bitmap bmp = BadgeRenderer.shortcutBitmapForClone(c, baseIcon, cl);
        if (bmp == null) bmp = BadgeRenderer.shortcutBitmap(
        ...
        return new ShortcutInfo.Builder(c, idFor(cl.pkg, cl.userId))
            ...
            .setLongLived(true)
            .setIntent(LauncherTrampoline.shortcutIntent(cl.pkg, cl.userId))
            .build();
    }
